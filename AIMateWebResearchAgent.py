    ...
    def do_research(self, human_input):
        ...
        system_message = SystemMessage(
            content="""You are a world class researcher, who can do detailed research on any topic and produce facts based results; 
                 ...
                 Please make sure you complete the objective above. Run through the following step by step:
                 ...
                 5/ In the final output, You should include all reference data and links to back up your research; You should include all reference data & links to back up your research."""
        )
        ...
        # llmsearch = ChatOpenAI(temperature=0, model="gpt-4")
